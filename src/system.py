...
from .lora.adapter_manager import QWEN25_LORA_REGISTRY, LoRAAdapterManager
...
class LatentMASSystem:
    ...
    def __init__(
        ...
        print("[INFO] Initializing LatentMAS System")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        if self._initialized:
            ...
            stats["memory_stats"] = (
                self._adapter_manager.get_memory_stats() if self._adapter_manager else {}
            )
