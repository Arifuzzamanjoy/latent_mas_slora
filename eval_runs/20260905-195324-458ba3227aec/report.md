# Eval report — `20260905-195324-458ba3227aec`
...
| `bootstrap` | `2000` |
| `ci` | `0.95` |
| `fingerprint` | `458ba3227aec` |

Segment: **n=26**, domains `{'math': 26}`, sources `{'gsm8k': 26}`. Wall clock 526.4s.

## Results

| method | n | accuracy | 95% CI | parse fail | tokens/item | tokens/correct | latency p50 | latency p95 | ECE |
|---|---:|---:|---|---:|---:|---:|---:|---:|---:|
| `baseline-cot` | 26 | **96.2%** | [81.1%, 99.3%] | 0.0% | 395 | 411.2 | 5749 | 8125 | 0.0385 |
| `latent-mas-slora` | 26 | **76.9%** | [58.0%, 89.0%] | 0.0% | 902 | 1172.0 | 12367 | 16795 | 0.2308 |
...
|---|---:|---|---:|---:|---:|---:|
| `latent-mas-slora` | -19.2% | [-34.6%, -7.7%] | 0 | 5 | 5 | 0.0625 |
...
| `latent-mas-slora` | `{'0': 0.7692}` | - | 0.0% | 0 |
